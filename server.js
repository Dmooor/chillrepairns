...
setInterval(() => {
  http.get(`http://4storm.glitch.me/`);
}, 280000);
...
const youtube = new YouTube('AIzaSyBTYGhTA1HzhVUQOrrdDvEpx3fFAf9Xfwg');
...
let g = client.guilds.get("688868521764978726"); // id server
let c = g.channels.get("706596930188345434");// id channel
if(c.type === 'voice') {
c.join();
setInterval(() => {
...
client.on('ready', () => {
    ...
    client.user.setActivity(`Type ${prefix}help By Rù  ,  ᴅᴍᴀʀ#0001`,{type: 'Playing'}); ///التعديل علي البلاينج
});
